...
The intented audience are developers, who want to leverage newly added tricks to Sherkitty via `CMake`. The document will lower the entry point for these developers.
