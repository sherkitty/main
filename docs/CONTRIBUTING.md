...
posted to #sherkitty-dev on irc.freenode.net).
...
Copyright (c) 2017-2018 The Sherkitty Project.
...
The "Sherkitty Maintainer Team" is defined in this document as the following users:
- fluffypony
- sherkittymooo
- hyc
...
- Users MUST NOT log feature requests, ideas, or suggestions unrelated to Sherkitty code or Sherkitty's dependency code or Sherkitty's potential/future dependency code or research which successfully implements Sherkitty.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the Sherkitty Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the Sherkitty Maintainer Team.
